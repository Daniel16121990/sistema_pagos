...
<head>
  ...
  <style>
    ...
    .logo-container img {
        max-width: 350px; /* Tamaño máximo para el logo SVG */
        width: 100%;
        height: auto;
    }
    /* Estilo modo oscuro para el contenedor del logo */
    @media (prefers-color-scheme: dark) {
        .logo-container {
  ...
  <div class="lg:grid lg:grid-cols-[280px_1fr] min-h-screen">
    ...
    >
      <div class="p-6 border-b border-gray-700">
        ...
        <p class="text-sm text-gray-400 mt-1">obrasDNL</p>
      </div>
    ...
    <div id="main-content-wrapper" class="flex flex-col flex-1 lg:pl-0 pt-16 lg:pt-0">
      ...
      <main id="dashboard-content" class="container p-6 flex-1">
        ...
        <div class="logo-container bg-white dark:bg-gray-700">
            <img src="recursos_graficos/logo1.svg" alt="Logo obrasDNL" class="transition duration-300" />
            
            <p class="lead text-xl font-bold mt-6 text-indigo-600 dark:text-indigo-400">
                👋 ¡Bienvenido al Dashboard de obrasDNL!
            </p>
            <p class="text-lg text-center mt-2 text-gray-600 dark:text-gray-300">
